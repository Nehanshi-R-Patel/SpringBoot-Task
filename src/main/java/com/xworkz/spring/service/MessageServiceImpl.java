...
import com.xworkz.spring.util.MessageMapper;
...
public class MessageServiceImpl implements MessageService {
	...
	public boolean validateAndSaveMessage(MessageDTO messageDTO, Model model) {
		...
		try {
			...
			if (flag == true) {
				MessageEntity entity = this.messageMapper.msgDTOToMsgEntity(messageDTO);
			...
			log.error("Exception occured in validateAndSaveMessage() " + e.getMessage());
		}
		return flag;
	}
